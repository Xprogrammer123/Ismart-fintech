		...
		<div className="phone:pl-4 phone:pr-4 pr-4 pl-4">
		{
			selectedCard && (
			  <div className='fixed w-[100vw] h-[100vh] top-0 left-0 bg-black bg-opacity-80 z-50 overflow-x-hidden'>
				<div className={`bg-main-bg w-full absolute flex flex-col bottom-0 left-0 rounded-tl-[4rem] rounded-tr-[4rem] pl-6 pr-6 pt-4 pb-4`}>
			...
			<Router>
				<Routes>
					...
					<Route path="/airtime-amount" element={<AirtimeAmount formData={formData} setFormData={setFormData} />} />
				</Routes>
			</Router>
		</div>
	);
